...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot PWM_IP_0 xil_defaultlib.PWM_IP_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PWM_IP_0 -key {Behavioral:sim_1:Functional:PWM_IP_0} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/nfs/xilinx/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PWM_IP_0.wdb xsim.dir libdpi.so)
