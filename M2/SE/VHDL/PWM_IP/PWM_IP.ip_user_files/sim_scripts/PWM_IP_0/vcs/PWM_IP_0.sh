...
#
# Script generated by Vivado on Wed Dec 13 15:36:37 CET 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : PWM_IP_0.sh
...
#
# Usage        : PWM_IP_0.sh
#                PWM_IP_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PWM_IP_0.sh [-reset_run]
#                PWM_IP_0.sh [-reset_log]
#                PWM_IP_0.sh [-help]
#
...
#                script (type 'PWM_IP_0.sh -help' for more information).
#
...
# script info
echo -e "PWM_IP_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PWM_IP_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.PWM_IP_0 -o PWM_IP_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./PWM_IP_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/nfs/home/camsi13/Documents/univ-documents/M2/SE/VHDL/PWM_IP/PWM_IP.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key PWM_IP_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc PWM_IP_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PWM_IP_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PWM_IP_0.sh [-help]\n\
Usage: PWM_IP_0.sh [-step]\n\
Usage: PWM_IP_0.sh [-lib_map_path]\n\
Usage: PWM_IP_0.sh [-reset_run]\n\
Usage: PWM_IP_0.sh [-reset_log]\n\
Usage: PWM_IP_0.sh [-keep_index]\n\
Usage: PWM_IP_0.sh [-noclean_files]\n\n\
